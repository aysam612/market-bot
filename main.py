...
# رابط قناتك على تليجرام (قم بتعديل المعرف إذا لزم الأمر)
CHANNEL_URL = "https://t.me/X9"
...
if __name__ == '__main__':
    print("Starting X9 Bot with Random USA Numbers and Telegram Stars (XTR)...")
    bot.remove_webhook()
